...
Aparte de eso, el sitio usa cookies de analítica y de publicidad: la maquinaria de siempre, la que nos dice qué página te trajo aquí y si valió la pena pagar por un anuncio. **Nada de eso se activa hasta que digas que sí.** Si las rechazas, igual tienes el sitio completo: cada ensayo, cada historia, la muestra de audio, el boletín. No te negamos nada ni te damos una versión peor. Creemos que esa es la única versión del consentimiento que significa algo.

No vendemos tus datos por dinero. Aun así, para la ley de California las cookies de publicidad cuentan como "compartir", y puedes desactivarlo con un solo clic.

Si quieres salirte por completo, escribe a [info@getlullable.com](mailto:info@getlullable.com) y borraremos lo que tengamos. No necesitas darnos una razón y no te la vamos a pedir.

Todo lo que sigue es la misma promesa, dicha con cuidado, porque una parte tiene que decirse así.

## Quiénes somos

**Tecnologías Stellar, S.A. de C.V.** ("Lullable" o "nosotros") es el responsable del tratamiento de los datos personales que se describen aquí.

- Domicilio: Agrarismo 38, Col. Escandón, Ciudad de México, C.P. 11800, México
- Correo electrónico: [info@getlullable.com](mailto:info@getlullable.com)
- Sitio web: [getlullable.com](https://getlullable.com)

Esta política cubre el sitio web getlullable.com, el boletín de Lullable y la app de Lullable. Está escrita para cumplir con la Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP) de México, con el RGPD (Reglamento General de Protección de Datos) de la Unión Europea y el RGPD del Reino Unido, y con la Ley de Privacidad del Consumidor de California (California Consumer Privacy Act) y sus reformas. El aviso de privacidad formal, el de la LFPDPPP, está al final de esta página.
...
**Si aceptas las cookies.** Entonces, las herramientas de analítica y de publicidad recopilan datos de uso y del dispositivo: páginas vistas, tiempo en la página, ubicación aproximada a partir de tu IP, sitio de procedencia, tipo de dispositivo y de navegador, e identificadores publicitarios asignados por las plataformas de anuncios. La siguiente sección las nombra una por una.

**Lo que nunca recopilamos.** Ningún dato de salud: no te preguntamos cómo dormiste, y Lullable no es un monitor de sueño. Ninguna ubicación precisa. Ni contactos, ni fotos, ni acceso al micrófono. Ningún dato sensible de ningún tipo, tal como los definen la ley mexicana y la europea.

**En la app.** Más abajo, una sección aparte describe la app con todo detalle, porque recopila cosas distintas de las que recopila el sitio web.

## Cookies y cómo rechazarlas

En tu primera visita, un aviso de cookies te pregunta. Hasta que lo respondas, no se carga nada de las categorías opcionales: no se descarga ningún script, no se coloca ningún identificador, no se envía nada a ningún lado. La única excepción es el registro de tu propia respuesta, que guardamos en tu dispositivo para no tener que volver a preguntarte; ese es inevitable y no lleva ningún identificador.

**Estrictamente necesarias: siempre activas.** Tu elección sobre las cookies, y la seguridad y el balanceo de carga que nuestro proveedor de hosting aplica a cada solicitud. Sin esto no se puede entregar el sitio, así que no hay nada que consentir.
...
- Vuelve a abrir el aviso de cookies desde el enlace en el pie de página del sitio y elige otra vez: el rechazo surte efecto de inmediato y elimina lo que se haya colocado.
- Activa **Global Privacy Control** en tu navegador o con una extensión. Tomamos una señal GPC como un rechazo válido de las cookies de analítica y de publicidad y, para efectos de la ley de California, como una solicitud para que no se compartan tus datos, de forma automática y sin que tengas que hacer nada más.
...
## Para qué usamos tus datos y qué es opcional
...
Vivas donde vivas, puedes pedirnos que te mostremos lo que tenemos, que lo corrijamos, que lo borremos o que dejemos de usarlo. Un solo correo sirve para todo: [info@getlullable.com](mailto:info@getlullable.com). Respondemos en un plazo de 20 días hábiles, que es el plazo legal en México y el más estricto de los que nos aplican. No tiene costo, y nunca te obligamos a crear una cuenta para ejercer un derecho.

**En México (LFPDPPP).** Tienes los derechos ARCO —Acceso, Rectificación, Cancelación, Oposición—, además del derecho a revocar tu consentimiento y a limitar el uso o la divulgación de tus datos; el aviso de cookies es uno de los medios que te ofrecemos para eso. Para ejercerlos, escríbenos con tu nombre, un medio de contacto, un documento que acredite tu identidad y una descripción clara de lo que quieres. Si no estás conforme con nuestra respuesta, puedes acudir a la autoridad mexicana competente en protección de datos.
...
Lullable está hecho para personas adultas y no está dirigido a menores de 13 años —o de 16 en el Espacio Económico Europeo y el Reino Unido—. No recopilamos sus datos a sabiendas y no les dirigimos publicidad. Si nos llegaran datos de algún menor, escribe a [info@getlullable.com](mailto:info@getlullable.com) y los borraremos sin demora. Por supuesto, madres y padres pueden ponerle una historia de Lullable a una niña o a un niño; eso no requiere cuenta y no nos da nada.

## Seguridad

Todo viaja por HTTPS. El acceso a la lista de correo está limitado a las personas que lo necesitan y protegido con autenticación robusta. Nosotros guardamos muy poco, y esa es la medida de seguridad más confiable que tenemos a nuestro alcance. Ningún sistema es perfecto, y si alguna vez una vulneración de seguridad afectara tus datos, te lo diríamos a ti y a la autoridad correspondiente sin demora.

## Una nota sobre la salud

Lullable es audio, no medicina. No es un dispositivo médico y no está pensado para diagnosticar, tratar, curar ni prevenir ninguna enfermedad. No recopilamos datos de salud de ningún tipo, y nunca creamos audiencias publicitarias en torno a nada relacionado con la salud. Si te está costando trabajo dormir, por favor habla con un médico; en los [Términos](/es/terms/) está la versión más completa de esto.

## Cambios a esta política

Si cambiamos algo que importe —una herramienta nueva, una finalidad nueva—, actualizaremos la fecha al inicio de esta página, volveremos a pedir tu consentimiento cuando sea el consentimiento lo que lo haga lícito, y lo diremos en el boletín antes de que entre en vigor. La versión vigente siempre está en [getlullable.com/es/privacy/](https://getlullable.com/es/privacy/).
